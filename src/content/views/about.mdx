...
# Things to do in <br/>The Hamptons 📅 🏖️ 🍾

Your curated guide to The Hamptons' most genuine experiences—events crafted by locals who know the coast best."

> **Info** ℹ️ <br />
> Things to do in the Hamptons is my first open-source project, so there may be some
> bugs or issues. I’ll address them as quickly as possible.

<Image
  src={screenshot}
  alt="Things to do in the Hamptons"
  layout="responsive"
